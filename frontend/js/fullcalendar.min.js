    ...
    return function(t) {
        ...
        var i = n(3),
            ...
            o = function() {
                ...
                // t.prototype.getBgPic = function(t) {
                //     var e, n, i = this.getStylingObjs(t);
                //     for (e = 0; e < i.length && !n; e++) n = i[e].eventBackgroundPic || i[e].backgroundPic;
                //     return n || (n = this.opt("eventBackgroundPic")), n
                // },
